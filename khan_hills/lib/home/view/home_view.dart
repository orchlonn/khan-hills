...
class Home extends StatefulWidget {
  List<GetRooms> getRooms;
  List<BannerData> getBannerLists;
  List<GetBrandList> getBrandList;

  Home(
      {Key? key,
      required this.getRooms,
      required this.getBannerLists,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Align(
                            ...
                            child: Text(
                              widget.getRooms[0].name,
                              style: CustomStyles.textSmallmSemiBold(context),
                            )),
                        SizedBox(height: size.height * .01),
                        DetailPhoto(photoUrl: widget.getRooms[0].aparts),
                        SizedBox(height: size.height * .01),
                        Align(
                            alignment: Alignment.centerLeft,
                            child: Text(
                              widget.getRooms[1].name,
                              style: CustomStyles.textSmallmSemiBold(context),
                            )),
                        SizedBox(height: size.height * .01),
                        // details of 4 rooms
                        DetailPhoto(photoUrl: widget.getRooms[1].aparts),
                        SizedBox(height: size.height * .01),
                        Align(
                            alignment: Alignment.centerLeft,
                            child: Text(
                              widget.getRooms[2].name,
                              style: CustomStyles.textSmallmSemiBold(context),
                            )),
                        SizedBox(height: size.height * .01),
                        // details of 3 rooms
